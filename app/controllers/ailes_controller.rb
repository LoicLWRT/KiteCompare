...
class AilesController < ApplicationController
  ...
  private
    ...
    def aile_params
      params.require(:aile).permit(:modele, :marque_id, :annee, :note, :prix_10m_sans_barre, :description, :score_relaunch, :score_highwind, :score_lowwind, :score_easyofuse, :score_wave, :score_unhooked, :url_flysurf)
    end
end

...
class MaterielsControllerTest < ActionController::TestCase
  ...
  test "should create materiel" do
    assert_difference('Materiel.count') do
      post :create, materiel: { annee: @materiel.annee, description_avantages: @materiel.description_avantages, description_inconvenients: @materiel.description_inconvenients, marque_id: @materiel.marque_id, materieltype_id: @materiel.materieltype_id, modele: @materiel.modele, prix_neuf: @materiel.prix_neuf, prix_occasion: @materiel.prix_occasion, url_image: @materiel.url_image }
    end
